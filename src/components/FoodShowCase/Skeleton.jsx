...
const Skeleton = () => {
    return (
        <div className="animate-pulse bg-white border border-gray-100 transition transform duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg relative">
            ...
            <div className="w-48 sm:w-64 h-48 bg-gray-200 mx-auto transform transition duration-300 hover:scale-105"></div>
            <div className="flex flex-col items-center my-3 space-y-2">
                ...
                <button className="bg-gray-400 text-white px-6 sm:px-8 py-3 focus:outline-none poppins rounded-full mt-6 sm:mt-24 transform transition duration-300 hover:scale-105"></button>
            </div>
        </div>
    );
};
